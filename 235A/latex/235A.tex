...
\begin{equation}
A_n(1) := \{ \mathbf{x}=(x_1,x_2,\ldots) \in \Omega : x_n = 1 \} \label{eq:specialcase}
\end{equation}
...
\begin{equation} \label{eq:indcointosses}
...
\begin{equation} \label{eq:lpnormmono}
...
\begin{align}
\label{eq:k-first-series} &\sum_{n=1}^\infty \mathrm{P}(|X_n|>1) = \sum_{n=1}^\infty \mathrm{P}(X_n\neq Y_n), \\
\label{eq:k-second-series} &\sum_{n=1}^\infty \mathbf{E}(Y_n), \\
\label{eq:k-third-series} &\sum_{n=1}^\infty \mathbf{V}(Y_n)
\end{align}
...
\begin{equation}
\label{eq:law-small-numbers-iid}
